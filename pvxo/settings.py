# Django settings for pvxo project.
...
ALLOWED_HOSTS = ['.provenuexo.appspot.com']
...
SECRET_KEY = '4%@#5k6+wla(0=&lc6jx8i^omm14!tpja%1!m)+60+v)r*^14#'
...
API_URL = 'http://217.19.241.119/services/TicketingAPIV2_6/TicketingAPI.svc'
